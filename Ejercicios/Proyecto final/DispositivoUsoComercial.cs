...
//Cargar usuarios
    ...
    {
        Usuarios u01 = new Usuarios(1, "Nahyeli Martínez", "001");
        ListadeUsuarios.Add(u01);

        Usuarios u02 = new Usuarios(2, "Erick García", "002");
        ListadeUsuarios.Add(u02);
        
        Usuarios u03= new Usuarios(3, "Jheny Martínez", "003");
        ListadeUsuarios.Add(u03);
        
        Usuarios u04= new Usuarios(4, "Madeline Ramírez", "004");
    ...
    public void cargarPostres()
    {
        ...
        Postres p06 = new Postres(6,   "Suspiro de Caramelo y Chocolate     ",   955);
    ...
    {
        Clientes c01 = new Clientes(1, "Nora Cortés  ", "9642-1054", "   0501-2000-08728");
        ListadeClientes.Add(c01);

        Clientes c02 = new Clientes(2, "Lorena Mejía  ", "8856-9123 " , "   0501-1998-00967");
        ListadeClientes.Add(c02);

        Clientes c03 = new Clientes(3, "Nahum Martínez   ", "3214-2345", "   0502-2001-17623");
        ListadeClientes.Add(c03);

        Clientes c04 = new Clientes(4, "David Hernández  ", "2553-6483 ", "   0203-1995-32456");
    ...
    public void ListarPostres()
    {
        ...
        Console.WriteLine("        Pastelería Nahyeli        ");
        Console.WriteLine("**************************************");
    ...
    public void CrearEntrada()
    {
        ...
        while(true)
        {
            ...
            Console.WriteLine("Desea ingresar otro postre? si/no");
    ...
    public void ListarEntrada()
    {
        ...
        Console.WriteLine("                                                    Pastelería Nahyeli                                               " );
        Console.WriteLine("***********************************************************************************************************************");
        Console.WriteLine("Codigo | Fecha              |Postre       | Cantidad |Precio | Subtotal | Impuesto | Total | Cliente       | Usuario ");
        Console.WriteLine("***********************************************************************************************************************");
        Console.WriteLine("");  
